...
public class EnemyDamage : MonoBehaviourPun
{
    ...
    */
    ...
    public void Attack()
    {
        //create circle of attack area to detect colliders with the enemy
    ...
    public void TakeDamage(int damage)
    {
        if (isAlive)
        {
            ...
            if (currentHealth <= 0)
            {
                ...
                m_animator.SetTrigger("Death");
                isAlive = false;
                Debug.Log("Enemy died with currentHealth " + currentHealth + " " + this.name);
                //make something so that the enemy can't move anymore
                this.enabled = false;
            }
        }
    }
